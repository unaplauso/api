...
CREATE TYPE "public"."file_type" AS ENUM('profile_pic', 'profile_banner', 'project_file');
...
CREATE TABLE "donation" (
	...
	"real_value" numeric GENERATED ALWAYS AS ("donation"."amount" * "donation"."quotation") STORED NOT NULL,
...
CREATE TABLE "user" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "username_format_check" CHECK ("user"."username" IS NULL OR "user"."username" ~ '^[a-zA-Z0-9_-]+$')
);
